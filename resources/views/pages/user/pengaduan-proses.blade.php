...
@section('content')
    ...
    <section class="page-header">
        <div class="container">
            <h1>{{ $judul }}</h1>
            <p>Laporan masyarakat yang sedang ditangani oleh petugas terkait</p>
        </div>
    </section>
            ...
            <div class="main-box">
                ...
                <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-4">
                    ...
                    <span class="text-muted">
                        Total Diproses: <strong>{{ $data->total() }}</strong>
                    </span>
                </div>

                <div class="info-box">
                    Semua laporan di halaman ini sedang dalam tahap penanganan atau proses tindak lanjut.
                </div>
                ...
                <div class="search-box">
                    <form method="GET">
                        <div class="row g-2">
                            <div class="col-md-10">
                                <input type="text" name="search" class="form-control" placeholder="Cari laporan diproses..."
