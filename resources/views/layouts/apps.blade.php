      ...
      {{-- <nav id="navbar" class="navbar order-last order-lg-0 ">
        <ul>
          ...
          <li><a class="nav-link scrollto {{ (request()->is('pengaduan.laporan')) ? 'active' : '' }}"
              href="{{ route('pengaduan.laporan', 'saya')}}">Pengaduan</a></li>
        </ul>
  ...
  <footer id="footer">
      ...
      <div class="container">
        <div class="row justify-content-between">
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            ...
            <ul>
              <p>
                <strong>Phone:</strong> +62 85743679377<br>
                <strong>Email:</strong> maganginaja@gmail.com<br>
              </p>
            </ul>
          </div>
    ...
    <div class="container d-md-flex py-4">
      ...
      <div class="me-md-auto my-auto text-center text-md-start">
        <div class="copyright">
          &copy; Copyright <strong><span><a href="" target="_blank">Brebes</a></span></strong> Beres
        </div>
      </div>
